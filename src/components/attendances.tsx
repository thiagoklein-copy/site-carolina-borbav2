...
export function Attendances() {
  return (
    <section className="relative isolate overflow-hidden bg-sombra text-creme">
      <div className="relative h-[28svh] min-h-[200px] max-h-[260px] overflow-hidden md:h-auto md:min-h-[42vh] md:max-h-none">
        <Image
        ...
        <div className="relative z-10 flex h-full flex-col items-center justify-center px-5 py-10 text-center md:min-h-[42vh] md:py-20">
          <Reveal>
